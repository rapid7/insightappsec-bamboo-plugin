...
import com.rapid7.ias.client.model.Pageobject;
...
public class SearchApi {
     ...
     */
    public com.squareup.okhttp.Call performSearchCall(SearchRequest searchRequest, Integer index, Integer size, String sort, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call performSearchValidateBeforeCall(SearchRequest searchRequest, Integer index, Integer size, String sort, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'searchRequest' is set
        if (searchRequest == null) {
            throw new ApiException("Missing the required parameter 'searchRequest' when calling performSearch(Async)");
        }
        

        com.squareup.okhttp.Call call = performSearchCall(searchRequest, index, size, sort, progressListener, progressRequestListener);
        return call;
    ...
    /**
     * Perform Search
     * Perform a Search for a set of resources, returning a page, based on supplied &lt;a href&#x3D;\&quot;#pagination\&quot;&gt;pagination parameters&lt;/a&gt;
     * @param searchRequest searchRequest (required)
     * @param index  (optional)
     * @param size  (optional)
     * @param sort  (optional)
     ...
     */
    public Pageobject performSearch(SearchRequest searchRequest, Integer index, Integer size, String sort) throws ApiException {
        ApiResponse<Pageobject> resp = performSearchWithHttpInfo(searchRequest, index, size, sort);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Pageobject> performSearchWithHttpInfo(SearchRequest searchRequest, Integer index, Integer size, String sort) throws ApiException {
        com.squareup.okhttp.Call call = performSearchValidateBeforeCall(searchRequest, index, size, sort, null, null);
     ...
     */
    public com.squareup.okhttp.Call performSearchAsync(SearchRequest searchRequest, Integer index, Integer size, String sort, final ApiCallback<Pageobject> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = performSearchValidateBeforeCall(searchRequest, index, size, sort, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<Pageobject>(){}.getType();
