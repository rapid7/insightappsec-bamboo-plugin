...
public class ScanStateActionResource {
  /**
   * Gets or Sets action
   */
  ...
  public ScanStateActionResource action(ActionEnum action) {
    this.action = action;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ScanStateActionResource scanStateActionResource = (ScanStateActionResource) o;
    return Objects.equals(this.action, scanStateActionResource.action);
  }
  ...
  public String toString() {
    ...
    sb.append("class ScanStateActionResource {\n");
