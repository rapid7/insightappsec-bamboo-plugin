...
public class ManualCrawlingConfig {
  @SerializedName("traffic_file_list")
  private java.util.List<TrafficFile> trafficFileList = null;

  public ManualCrawlingConfig trafficFileList(java.util.List<TrafficFile> trafficFileList) {
    this.trafficFileList = trafficFileList;
    return this;
  }

  public ManualCrawlingConfig addTrafficFileListItem(TrafficFile trafficFileListItem) {
    if (this.trafficFileList == null) {
      this.trafficFileList = new java.util.ArrayList<TrafficFile>();
    }
    this.trafficFileList.add(trafficFileListItem);
    return this;
  }

   /**
   * Get trafficFileList
   * @return trafficFileList
  **/
  @ApiModelProperty(value = "")
  public java.util.List<TrafficFile> getTrafficFileList() {
    return trafficFileList;
  }

  public void setTrafficFileList(java.util.List<TrafficFile> trafficFileList) {
    this.trafficFileList = trafficFileList;
  }
  ...
  public boolean equals(Object o) {
    ...
    ManualCrawlingConfig manualCrawlingConfig = (ManualCrawlingConfig) o;
    return Objects.equals(this.trafficFileList, manualCrawlingConfig.trafficFileList);
  }

  @Override
  public int hashCode() {
    return Objects.hash(trafficFileList);
  }
  ...
  public String toString() {
    ...
    sb.append("class ManualCrawlingConfig {\n");

    sb.append("    trafficFileList: ").append(toIndentedString(trafficFileList)).append("\n");
    sb.append("}");
    return sb.toString();
  }
