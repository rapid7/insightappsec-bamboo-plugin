...
public class SequenceConfig {
  ...
  private Boolean autoSequenceConfig = null;

  @SerializedName("manual_sequence_config")
  private ManualSequenceConfig manualSequenceConfig = null;

  @SerializedName("reset_session")
  private Boolean resetSession = null;

  public SequenceConfig autoSequenceConfig(Boolean autoSequenceConfig) {
  ...
  **/
  ...
  public Boolean isAutoSequenceConfig() {
    return autoSequenceConfig;
  }

  public void setAutoSequenceConfig(Boolean autoSequenceConfig) {
    this.autoSequenceConfig = autoSequenceConfig;
  }

  public SequenceConfig manualSequenceConfig(ManualSequenceConfig manualSequenceConfig) {
    this.manualSequenceConfig = manualSequenceConfig;
    return this;
  }

   /**
   * Get manualSequenceConfig
   * @return manualSequenceConfig
  **/
  @ApiModelProperty(value = "")
  public ManualSequenceConfig getManualSequenceConfig() {
    return manualSequenceConfig;
  }

  public void setManualSequenceConfig(ManualSequenceConfig manualSequenceConfig) {
    this.manualSequenceConfig = manualSequenceConfig;
  }

  public SequenceConfig resetSession(Boolean resetSession) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    SequenceConfig sequenceConfig = (SequenceConfig) o;
    return Objects.equals(this.autoSequenceConfig, sequenceConfig.autoSequenceConfig) &&
        Objects.equals(this.manualSequenceConfig, sequenceConfig.manualSequenceConfig) &&
        Objects.equals(this.resetSession, sequenceConfig.resetSession);
  }

  @Override
  public int hashCode() {
    return Objects.hash(autoSequenceConfig, manualSequenceConfig, resetSession);
  }
  ...
  public String toString() {
    ...
    sb.append("class SequenceConfig {\n");

    sb.append("    autoSequenceConfig: ").append(toIndentedString(autoSequenceConfig)).append("\n");
    sb.append("    manualSequenceConfig: ").append(toIndentedString(manualSequenceConfig)).append("\n");
    sb.append("    resetSession: ").append(toIndentedString(resetSession)).append("\n");
    sb.append("}");
    return sb.toString();
  }
