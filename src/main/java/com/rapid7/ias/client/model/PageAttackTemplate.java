...
public class PageAttackTemplate {
  @SerializedName("data")
  private java.util.List<ResourceAttackTemplate> data = null;
  ...
  public PageAttackTemplate data(java.util.List<ResourceAttackTemplate> data) {
    this.data = data;
    return this;
  }

  public PageAttackTemplate addDataItem(ResourceAttackTemplate dataItem) {
    if (this.data == null) {
      this.data = new java.util.ArrayList<ResourceAttackTemplate>();
    }
  ...
  **/
  ...
  public java.util.List<ResourceAttackTemplate> getData() {
    return data;
  }

  public void setData(java.util.List<ResourceAttackTemplate> data) {
    this.data = data;
  }

  public PageAttackTemplate metadata(PageMetadata metadata) {
  ...
  **/
  ...
  public PageAttackTemplate links(java.util.List<Link> links) {
    this.links = links;
    return this;
  }

  public PageAttackTemplate addLinksItem(Link linksItem) {
    if (this.links == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PageAttackTemplate pageAttackTemplate = (PageAttackTemplate) o;
    return Objects.equals(this.data, pageAttackTemplate.data) &&
        Objects.equals(this.metadata, pageAttackTemplate.metadata) &&
        Objects.equals(this.links, pageAttackTemplate.links);
  }
  ...
  public String toString() {
    ...
    sb.append("class PageAttackTemplate {\n");
