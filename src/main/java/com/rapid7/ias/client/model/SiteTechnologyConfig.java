...
public class SiteTechnologyConfig {
  @SerializedName("autodetect")
  private Boolean autodetect = null;

  @SerializedName("language_list")
  private java.util.List<Language> languageList = null;

  @SerializedName("region_list")
  private java.util.List<Region> regionList = null;

  /**
   * Gets or Sets serverPerformance
   */
  @JsonAdapter(ServerPerformanceEnum.Adapter.class)
  public enum ServerPerformanceEnum {
    UNKNOWN("UNKNOWN"),
    ...
    ServerPerformanceEnum(String value) {
      this.value = value;
    }
    ...
    public static ServerPerformanceEnum fromValue(String text) {
      for (ServerPerformanceEnum b : ServerPerformanceEnum.values()) {
    ...
    public static class Adapter extends TypeAdapter<ServerPerformanceEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final ServerPerformanceEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public ServerPerformanceEnum read(final JsonReader jsonReader) throws IOException {
        String value = jsonReader.nextString();
        return ServerPerformanceEnum.fromValue(String.valueOf(value));
      }
    }
  }

  @SerializedName("server_performance")
  private ServerPerformanceEnum serverPerformance = null;

  @SerializedName("technology_targets")
  private TechnologyTargets technologyTargets = null;

  public SiteTechnologyConfig autodetect(Boolean autodetect) {
  ...
  **/
  ...
  public SiteTechnologyConfig languageList(java.util.List<Language> languageList) {
    this.languageList = languageList;
    return this;
  }

  public SiteTechnologyConfig addLanguageListItem(Language languageListItem) {
    if (this.languageList == null) {
      this.languageList = new java.util.ArrayList<Language>();
    }
  ...
  **/
  @ApiModelProperty(value = "")
  public java.util.List<Language> getLanguageList() {
    return languageList;
  }

  public void setLanguageList(java.util.List<Language> languageList) {
    this.languageList = languageList;
  }

  public SiteTechnologyConfig regionList(java.util.List<Region> regionList) {
    this.regionList = regionList;
    return this;
  }

  public SiteTechnologyConfig addRegionListItem(Region regionListItem) {
    if (this.regionList == null) {
      this.regionList = new java.util.ArrayList<Region>();
    }
  ...
  **/
  ...
  public void setRegionList(java.util.List<Region> regionList) {
    this.regionList = regionList;
  }

  public SiteTechnologyConfig serverPerformance(ServerPerformanceEnum serverPerformance) {
  ...
  **/
  @ApiModelProperty(value = "")
  public ServerPerformanceEnum getServerPerformance() {
    return serverPerformance;
  }

  public void setServerPerformance(ServerPerformanceEnum serverPerformance) {
    this.serverPerformance = serverPerformance;
  }

  public SiteTechnologyConfig technologyTargets(TechnologyTargets technologyTargets) {
    this.technologyTargets = technologyTargets;
    return this;
  }

   /**
   * Get technologyTargets
   * @return technologyTargets
  **/
  @ApiModelProperty(value = "")
  public TechnologyTargets getTechnologyTargets() {
    return technologyTargets;
  }

  public void setTechnologyTargets(TechnologyTargets technologyTargets) {
    this.technologyTargets = technologyTargets;
  }
  ...
  public boolean equals(Object o) {
    ...
    SiteTechnologyConfig siteTechnologyConfig = (SiteTechnologyConfig) o;
    return Objects.equals(this.autodetect, siteTechnologyConfig.autodetect) &&
        Objects.equals(this.languageList, siteTechnologyConfig.languageList) &&
        Objects.equals(this.regionList, siteTechnologyConfig.regionList) &&
        Objects.equals(this.serverPerformance, siteTechnologyConfig.serverPerformance) &&
        Objects.equals(this.technologyTargets, siteTechnologyConfig.technologyTargets);
  }

  @Override
  public int hashCode() {
    return Objects.hash(autodetect, languageList, regionList, serverPerformance, technologyTargets);
  }
  ...
  public String toString() {
    ...
    sb.append("class SiteTechnologyConfig {\n");
    ...
    sb.append("    serverPerformance: ").append(toIndentedString(serverPerformance)).append("\n");
    sb.append("    technologyTargets: ").append(toIndentedString(technologyTargets)).append("\n");
    sb.append("}");
    return sb.toString();
  }
