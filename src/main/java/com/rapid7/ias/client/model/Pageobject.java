...
public class Pageobject {
  @SerializedName("data")
  private java.util.List<Resourceobject> data = null;
  ...
  public Pageobject data(java.util.List<Resourceobject> data) {
    this.data = data;
    return this;
  }

  public Pageobject addDataItem(Resourceobject dataItem) {
    if (this.data == null) {
      this.data = new java.util.ArrayList<Resourceobject>();
    }
  ...
  **/
  ...
  public java.util.List<Resourceobject> getData() {
    return data;
  }

  public void setData(java.util.List<Resourceobject> data) {
    this.data = data;
  }

  public Pageobject metadata(PageMetadata metadata) {
  ...
  **/
  ...
  public Pageobject links(java.util.List<Link> links) {
    this.links = links;
    return this;
  }

  public Pageobject addLinksItem(Link linksItem) {
    if (this.links == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, pageobject.data) &&
        Objects.equals(this.metadata, pageobject.metadata) &&
        Objects.equals(this.links, pageobject.links);
  }
