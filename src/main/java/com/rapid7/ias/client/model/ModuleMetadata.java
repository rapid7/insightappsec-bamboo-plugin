...
public class ModuleMetadata {
  ...
  **/
   ...
   * @return name
  **/
  @ApiModelProperty(value = "The name of the module")
   ...
   * @return description
  **/
  @ApiModelProperty(value = "The description of the module")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, moduleMetadata.id) &&
        Objects.equals(this.name, moduleMetadata.name) &&
        Objects.equals(this.description, moduleMetadata.description);
  }
