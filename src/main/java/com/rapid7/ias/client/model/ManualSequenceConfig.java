...
public class ManualSequenceConfig {
  @SerializedName("sequence_request_list")
  private java.util.List<SequenceRequestList> sequenceRequestList = null;

  public ManualSequenceConfig sequenceRequestList(java.util.List<SequenceRequestList> sequenceRequestList) {
    this.sequenceRequestList = sequenceRequestList;
    return this;
  }

  public ManualSequenceConfig addSequenceRequestListItem(SequenceRequestList sequenceRequestListItem) {
    if (this.sequenceRequestList == null) {
      this.sequenceRequestList = new java.util.ArrayList<SequenceRequestList>();
    }
    this.sequenceRequestList.add(sequenceRequestListItem);
    return this;
  }

   /**
   * Get sequenceRequestList
   * @return sequenceRequestList
  **/
  @ApiModelProperty(value = "")
  public java.util.List<SequenceRequestList> getSequenceRequestList() {
    return sequenceRequestList;
  }

  public void setSequenceRequestList(java.util.List<SequenceRequestList> sequenceRequestList) {
    this.sequenceRequestList = sequenceRequestList;
  }
  ...
  public boolean equals(Object o) {
    ...
    ManualSequenceConfig manualSequenceConfig = (ManualSequenceConfig) o;
    return Objects.equals(this.sequenceRequestList, manualSequenceConfig.sequenceRequestList);
  }

  @Override
  public int hashCode() {
    return Objects.hash(sequenceRequestList);
  }
  ...
  public String toString() {
    ...
    sb.append("class ManualSequenceConfig {\n");

    sb.append("    sequenceRequestList: ").append(toIndentedString(sequenceRequestList)).append("\n");
    sb.append("}");
    return sb.toString();
  }
