...
public class TrafficFile {
  @SerializedName("attack_as_sequence")
  private Boolean attackAsSequence = null;

  @SerializedName("begin_attack_request")
  private Long beginAttackRequest = null;

  @SerializedName("end_attack_request")
  private Long endAttackRequest = null;

  @SerializedName("traffic_file_name")
  private String trafficFileName = null;

  @SerializedName("traffic_file_password")
  private String trafficFilePassword = null;

  public TrafficFile attackAsSequence(Boolean attackAsSequence) {
    this.attackAsSequence = attackAsSequence;
    return this;
  }

   /**
   * Get attackAsSequence
   * @return attackAsSequence
  **/
  @ApiModelProperty(value = "")
  public Boolean isAttackAsSequence() {
    return attackAsSequence;
  }

  public void setAttackAsSequence(Boolean attackAsSequence) {
    this.attackAsSequence = attackAsSequence;
  }

  public TrafficFile beginAttackRequest(Long beginAttackRequest) {
    this.beginAttackRequest = beginAttackRequest;
    return this;
  }

   /**
   * Get beginAttackRequest
   * @return beginAttackRequest
  **/
  @ApiModelProperty(value = "")
  public Long getBeginAttackRequest() {
    return beginAttackRequest;
  }

  public void setBeginAttackRequest(Long beginAttackRequest) {
    this.beginAttackRequest = beginAttackRequest;
  }

  public TrafficFile endAttackRequest(Long endAttackRequest) {
    this.endAttackRequest = endAttackRequest;
    return this;
  }

   /**
   * Get endAttackRequest
   * @return endAttackRequest
  **/
  @ApiModelProperty(value = "")
  public Long getEndAttackRequest() {
    return endAttackRequest;
  }

  public void setEndAttackRequest(Long endAttackRequest) {
    this.endAttackRequest = endAttackRequest;
  }

  public TrafficFile trafficFileName(String trafficFileName) {
  ...
  **/
  ...
  public TrafficFile trafficFilePassword(String trafficFilePassword) {
    this.trafficFilePassword = trafficFilePassword;
    return this;
  }

   /**
   * Get trafficFilePassword
  ...
  **/
  ...
  public void setTrafficFilePassword(String trafficFilePassword) {
    this.trafficFilePassword = trafficFilePassword;
  }
  ...
  public boolean equals(Object o) {
    ...
    TrafficFile trafficFile = (TrafficFile) o;
    return Objects.equals(this.attackAsSequence, trafficFile.attackAsSequence) &&
        Objects.equals(this.beginAttackRequest, trafficFile.beginAttackRequest) &&
        Objects.equals(this.endAttackRequest, trafficFile.endAttackRequest) &&
        Objects.equals(this.trafficFileName, trafficFile.trafficFileName) &&
        Objects.equals(this.trafficFilePassword, trafficFile.trafficFilePassword);
  }

  @Override
  public int hashCode() {
    return Objects.hash(attackAsSequence, beginAttackRequest, endAttackRequest, trafficFileName, trafficFilePassword);
  }
  ...
  public String toString() {
    ...
    sb.append("class TrafficFile {\n");

    sb.append("    attackAsSequence: ").append(toIndentedString(attackAsSequence)).append("\n");
    sb.append("    beginAttackRequest: ").append(toIndentedString(beginAttackRequest)).append("\n");
    sb.append("    endAttackRequest: ").append(toIndentedString(endAttackRequest)).append("\n");
    sb.append("    trafficFileName: ").append(toIndentedString(trafficFileName)).append("\n");
    sb.append("    trafficFilePassword: ").append(toIndentedString(trafficFilePassword)).append("\n");
    sb.append("}");
    return sb.toString();
  }
