...
public class AttackTemplate {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    AttackTemplate attackTemplate = (AttackTemplate) o;
    return Objects.equals(this.id, attackTemplate.id) &&
        Objects.equals(this.name, attackTemplate.name) &&
        Objects.equals(this.description, attackTemplate.description) &&
        Objects.equals(this.systemDefined, attackTemplate.systemDefined);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, name, description, systemDefined);
  }
  ...
  public String toString() {
    ...
    sb.append("class AttackTemplate {\n");
