...
public class Target {
  ...
  **/
  ...
  public Target domain(String domain) {
    this.domain = domain;
    return this;
  }
  ...
  **/
  ...
  public Target enabled(Boolean enabled) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, target.id) &&
        Objects.equals(this.domain, target.domain) &&
        Objects.equals(this.enabled, target.enabled);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, domain, enabled);
  }
