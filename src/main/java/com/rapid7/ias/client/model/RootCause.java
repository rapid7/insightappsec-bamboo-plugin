...
public class RootCause {
  ...
  **/
   ...
   * @return parameter
  **/
  @ApiModelProperty(value = "The parameter from the URL")
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.url, rootCause.url) &&
        Objects.equals(this.parameter, rootCause.parameter) &&
        Objects.equals(this.method, rootCause.method);
  }

  @Override
  public int hashCode() {
    return Objects.hash(url, parameter, method);
  }
