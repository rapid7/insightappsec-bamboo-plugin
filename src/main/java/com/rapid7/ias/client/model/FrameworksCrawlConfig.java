...
public class FrameworksCrawlConfig {
  @SerializedName("enable_frameworks_crawling")
  private Boolean enableFrameworksCrawling = null;

  @SerializedName("framework_config_list")
  private java.util.List<FrameworkConfig> frameworkConfigList = null;

  @SerializedName("react_js_detection_regex")
  private String reactJsDetectionRegex = null;

  public FrameworksCrawlConfig enableFrameworksCrawling(Boolean enableFrameworksCrawling) {
    this.enableFrameworksCrawling = enableFrameworksCrawling;
    return this;
  }

   /**
   * Get enableFrameworksCrawling
   * @return enableFrameworksCrawling
  **/
  @ApiModelProperty(value = "")
  public Boolean isEnableFrameworksCrawling() {
    return enableFrameworksCrawling;
  }

  public void setEnableFrameworksCrawling(Boolean enableFrameworksCrawling) {
    this.enableFrameworksCrawling = enableFrameworksCrawling;
  }

  public FrameworksCrawlConfig frameworkConfigList(java.util.List<FrameworkConfig> frameworkConfigList) {
    this.frameworkConfigList = frameworkConfigList;
    return this;
  }

  public FrameworksCrawlConfig addFrameworkConfigListItem(FrameworkConfig frameworkConfigListItem) {
    if (this.frameworkConfigList == null) {
      this.frameworkConfigList = new java.util.ArrayList<FrameworkConfig>();
    }
    this.frameworkConfigList.add(frameworkConfigListItem);
    return this;
  }

   /**
   * Get frameworkConfigList
   * @return frameworkConfigList
  **/
  @ApiModelProperty(value = "")
  public java.util.List<FrameworkConfig> getFrameworkConfigList() {
    return frameworkConfigList;
  }

  public void setFrameworkConfigList(java.util.List<FrameworkConfig> frameworkConfigList) {
    this.frameworkConfigList = frameworkConfigList;
  }

  public FrameworksCrawlConfig reactJsDetectionRegex(String reactJsDetectionRegex) {
    this.reactJsDetectionRegex = reactJsDetectionRegex;
    return this;
  }

   /**
   * Get reactJsDetectionRegex
   * @return reactJsDetectionRegex
  **/
  @ApiModelProperty(value = "")
  public String getReactJsDetectionRegex() {
    return reactJsDetectionRegex;
  }

  public void setReactJsDetectionRegex(String reactJsDetectionRegex) {
    this.reactJsDetectionRegex = reactJsDetectionRegex;
  }
  ...
  public boolean equals(Object o) {
    ...
    FrameworksCrawlConfig frameworksCrawlConfig = (FrameworksCrawlConfig) o;
    return Objects.equals(this.enableFrameworksCrawling, frameworksCrawlConfig.enableFrameworksCrawling) &&
        Objects.equals(this.frameworkConfigList, frameworksCrawlConfig.frameworkConfigList) &&
        Objects.equals(this.reactJsDetectionRegex, frameworksCrawlConfig.reactJsDetectionRegex);
  }

  @Override
  public int hashCode() {
    return Objects.hash(enableFrameworksCrawling, frameworkConfigList, reactJsDetectionRegex);
  }
  ...
  public String toString() {
    ...
    sb.append("class FrameworksCrawlConfig {\n");

    sb.append("    enableFrameworksCrawling: ").append(toIndentedString(enableFrameworksCrawling)).append("\n");
    sb.append("    frameworkConfigList: ").append(toIndentedString(frameworkConfigList)).append("\n");
    sb.append("    reactJsDetectionRegex: ").append(toIndentedString(reactJsDetectionRegex)).append("\n");
    sb.append("}");
    return sb.toString();
  }
