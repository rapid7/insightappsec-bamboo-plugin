...
public class ScanConfig {
  ...
  **/
  ...
  public ScanConfig errors(java.util.List<String> errors) {
    this.errors = errors;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, scanConfig.id) &&
        Objects.equals(this.name, scanConfig.name) &&
        Objects.equals(this.description, scanConfig.description) &&
        Objects.equals(this.app, scanConfig.app) &&
        Objects.equals(this.attackTemplate, scanConfig.attackTemplate) &&
        Objects.equals(this.errors, scanConfig.errors);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, name, description, app, attackTemplate, errors);
  }
