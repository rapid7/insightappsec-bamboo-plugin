...
public class StandardUrlParserConfig {
  @SerializedName("path_name_value_delimiters")
  private String pathNameValueDelimiters = null;

  @SerializedName("path_parameter_delimiters")
  private String pathParameterDelimiters = null;

  @SerializedName("path_params_value_regex")
  private String pathParamsValueRegex = null;

  @SerializedName("query_name_value_delimiters")
  private String queryNameValueDelimiters = null;

  @SerializedName("query_parameter_delimiters")
  private String queryParameterDelimiters = null;

  @SerializedName("start_path_params_position")
  private Long startPathParamsPosition = null;

  public StandardUrlParserConfig pathNameValueDelimiters(String pathNameValueDelimiters) {
    this.pathNameValueDelimiters = pathNameValueDelimiters;
    return this;
  }

   /**
   * Get pathNameValueDelimiters
   * @return pathNameValueDelimiters
  **/
  @ApiModelProperty(value = "")
  public String getPathNameValueDelimiters() {
    return pathNameValueDelimiters;
  }

  public void setPathNameValueDelimiters(String pathNameValueDelimiters) {
    this.pathNameValueDelimiters = pathNameValueDelimiters;
  }

  public StandardUrlParserConfig pathParameterDelimiters(String pathParameterDelimiters) {
    this.pathParameterDelimiters = pathParameterDelimiters;
    return this;
  }

   /**
   * Get pathParameterDelimiters
   * @return pathParameterDelimiters
  **/
  @ApiModelProperty(value = "")
  public String getPathParameterDelimiters() {
    return pathParameterDelimiters;
  }

  public void setPathParameterDelimiters(String pathParameterDelimiters) {
    this.pathParameterDelimiters = pathParameterDelimiters;
  }

  public StandardUrlParserConfig pathParamsValueRegex(String pathParamsValueRegex) {
    this.pathParamsValueRegex = pathParamsValueRegex;
    return this;
  }

   /**
   * Get pathParamsValueRegex
   * @return pathParamsValueRegex
  **/
  @ApiModelProperty(value = "")
  public String getPathParamsValueRegex() {
    return pathParamsValueRegex;
  }

  public void setPathParamsValueRegex(String pathParamsValueRegex) {
    this.pathParamsValueRegex = pathParamsValueRegex;
  }

  public StandardUrlParserConfig queryNameValueDelimiters(String queryNameValueDelimiters) {
    this.queryNameValueDelimiters = queryNameValueDelimiters;
    return this;
  }

   /**
   * Get queryNameValueDelimiters
   * @return queryNameValueDelimiters
  **/
  @ApiModelProperty(value = "")
  public String getQueryNameValueDelimiters() {
    return queryNameValueDelimiters;
  }

  public void setQueryNameValueDelimiters(String queryNameValueDelimiters) {
    this.queryNameValueDelimiters = queryNameValueDelimiters;
  }

  public StandardUrlParserConfig queryParameterDelimiters(String queryParameterDelimiters) {
    this.queryParameterDelimiters = queryParameterDelimiters;
    return this;
  }

   /**
   * Get queryParameterDelimiters
   * @return queryParameterDelimiters
  **/
  @ApiModelProperty(value = "")
  public String getQueryParameterDelimiters() {
    return queryParameterDelimiters;
  }

  public void setQueryParameterDelimiters(String queryParameterDelimiters) {
    this.queryParameterDelimiters = queryParameterDelimiters;
  }

  public StandardUrlParserConfig startPathParamsPosition(Long startPathParamsPosition) {
    this.startPathParamsPosition = startPathParamsPosition;
    return this;
  }

   /**
   * Get startPathParamsPosition
   * @return startPathParamsPosition
  **/
  @ApiModelProperty(value = "")
  public Long getStartPathParamsPosition() {
    return startPathParamsPosition;
  }

  public void setStartPathParamsPosition(Long startPathParamsPosition) {
    this.startPathParamsPosition = startPathParamsPosition;
  }
  ...
  public boolean equals(Object o) {
    ...
    StandardUrlParserConfig standardUrlParserConfig = (StandardUrlParserConfig) o;
    return Objects.equals(this.pathNameValueDelimiters, standardUrlParserConfig.pathNameValueDelimiters) &&
        Objects.equals(this.pathParameterDelimiters, standardUrlParserConfig.pathParameterDelimiters) &&
        Objects.equals(this.pathParamsValueRegex, standardUrlParserConfig.pathParamsValueRegex) &&
        Objects.equals(this.queryNameValueDelimiters, standardUrlParserConfig.queryNameValueDelimiters) &&
        Objects.equals(this.queryParameterDelimiters, standardUrlParserConfig.queryParameterDelimiters) &&
        Objects.equals(this.startPathParamsPosition, standardUrlParserConfig.startPathParamsPosition);
  }

  @Override
  public int hashCode() {
    return Objects.hash(pathNameValueDelimiters, pathParameterDelimiters, pathParamsValueRegex, queryNameValueDelimiters, queryParameterDelimiters, startPathParamsPosition);
  }
  ...
  public String toString() {
    ...
    sb.append("class StandardUrlParserConfig {\n");

    sb.append("    pathNameValueDelimiters: ").append(toIndentedString(pathNameValueDelimiters)).append("\n");
    sb.append("    pathParameterDelimiters: ").append(toIndentedString(pathParameterDelimiters)).append("\n");
    sb.append("    pathParamsValueRegex: ").append(toIndentedString(pathParamsValueRegex)).append("\n");
    sb.append("    queryNameValueDelimiters: ").append(toIndentedString(queryNameValueDelimiters)).append("\n");
    sb.append("    queryParameterDelimiters: ").append(toIndentedString(queryParameterDelimiters)).append("\n");
    sb.append("    startPathParamsPosition: ").append(toIndentedString(startPathParamsPosition)).append("\n");
    sb.append("}");
    return sb.toString();
  }
