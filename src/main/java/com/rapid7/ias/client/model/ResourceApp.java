...
public class ResourceApp {
  ...
  **/
  ...
  public ResourceApp name(String name) {
    this.name = name;
    return this;
  }
   ...
   * @return name
  **/
  @ApiModelProperty(required = true, value = "The name of the App")
  ...
  public ResourceApp description(String description) {
  ...
  **/
  ...
  public ResourceApp links(java.util.List<Link> links) {
    this.links = links;
    return this;
  }

  public ResourceApp addLinksItem(Link linksItem) {
    if (this.links == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ResourceApp resourceApp = (ResourceApp) o;
    return Objects.equals(this.id, resourceApp.id) &&
        Objects.equals(this.name, resourceApp.name) &&
        Objects.equals(this.description, resourceApp.description) &&
        Objects.equals(this.links, resourceApp.links);
  }
