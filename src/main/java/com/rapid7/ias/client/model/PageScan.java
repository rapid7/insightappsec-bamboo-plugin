...
public class PageScan {
  @SerializedName("data")
  private java.util.List<ResourceScan> data = null;
  ...
  public PageScan data(java.util.List<ResourceScan> data) {
    this.data = data;
    return this;
  }

  public PageScan addDataItem(ResourceScan dataItem) {
    if (this.data == null) {
      this.data = new java.util.ArrayList<ResourceScan>();
    }
  ...
  **/
  ...
  public java.util.List<ResourceScan> getData() {
    return data;
  }

  public void setData(java.util.List<ResourceScan> data) {
    this.data = data;
  }

  public PageScan metadata(PageMetadata metadata) {
  ...
  **/
  ...
  public PageScan links(java.util.List<Link> links) {
    this.links = links;
    return this;
  }

  public PageScan addLinksItem(Link linksItem) {
    if (this.links == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PageScan pageScan = (PageScan) o;
    return Objects.equals(this.data, pageScan.data) &&
        Objects.equals(this.metadata, pageScan.metadata) &&
        Objects.equals(this.links, pageScan.links);
  }
