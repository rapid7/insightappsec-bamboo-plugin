...
public class ResourceAttackTemplate {
  ...
  private java.util.List<Link> links = null;
   ...
   /**
   * The ID of the attack template
   * @return id
  **/
  @ApiModelProperty(value = "The ID of the attack template")
  public java.util.UUID getId() {
    return id;
  }

   /**
   * The name of the attack template
   * @return name
  **/
  @ApiModelProperty(value = "The name of the attack template")
  public String getName() {
    return name;
  }

   /**
   * The description of the attack template
   * @return description
  **/
  @ApiModelProperty(value = "The description of the attack template")
  public String getDescription() {
    return description;
  }

   /**
   * Indication of the attack template being system defined
   * @return systemDefined
  **/
  @ApiModelProperty(value = "Indication of the attack template being system defined")
  public Boolean isSystemDefined() {
    return systemDefined;
  }

  public ResourceAttackTemplate links(java.util.List<Link> links) {
    this.links = links;
    return this;
  }

  public ResourceAttackTemplate addLinksItem(Link linksItem) {
    if (this.links == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ResourceAttackTemplate resourceAttackTemplate = (ResourceAttackTemplate) o;
    return Objects.equals(this.id, resourceAttackTemplate.id) &&
        Objects.equals(this.name, resourceAttackTemplate.name) &&
        Objects.equals(this.description, resourceAttackTemplate.description) &&
        Objects.equals(this.systemDefined, resourceAttackTemplate.systemDefined) &&
        Objects.equals(this.links, resourceAttackTemplate.links);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, name, description, systemDefined, links);
  }
  ...
  public String toString() {
    ...
    sb.append("class ResourceAttackTemplate {\n");
