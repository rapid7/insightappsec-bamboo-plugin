...
public class StringReferenceResource {
  @SerializedName("id")
  private String id = null;

  public StringReferenceResource id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    StringReferenceResource stringReferenceResource = (StringReferenceResource) o;
    return Objects.equals(this.id, stringReferenceResource.id);
  }
  ...
  public String toString() {
    ...
    sb.append("class StringReferenceResource {\n");
