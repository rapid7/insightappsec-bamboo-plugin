...
public class ResourceTarget {
  ...
  **/
  ...
  public ResourceTarget domain(String domain) {
    this.domain = domain;
    return this;
  }

   /**
   * The fully qualified domain name of the Target
   * @return domain
  **/
  @ApiModelProperty(required = true, value = "The fully qualified domain name of the Target")
  ...
  public ResourceTarget enabled(Boolean enabled) {
    this.enabled = enabled;
    return this;
  }

   /**
   * The enabled property of the Target
   * @return enabled
  **/
  @ApiModelProperty(value = "The enabled property of the Target")
  ...
  public ResourceTarget links(java.util.List<Link> links) {
    this.links = links;
    return this;
  }

  public ResourceTarget addLinksItem(Link linksItem) {
    if (this.links == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, resourceTarget.id) &&
        Objects.equals(this.domain, resourceTarget.domain) &&
        Objects.equals(this.enabled, resourceTarget.enabled) &&
        Objects.equals(this.links, resourceTarget.links);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, domain, enabled, links);
  }
