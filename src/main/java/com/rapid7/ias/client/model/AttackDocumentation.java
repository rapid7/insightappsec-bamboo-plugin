...
public class AttackDocumentation {
  @SerializedName("references")
  private java.util.Map<String, String> references = null;
  ...
  public AttackDocumentation references(java.util.Map<String, String> references) {
    this.references = references;
    return this;
  }

  public AttackDocumentation putReferencesItem(String key, String referencesItem) {
    if (this.references == null) {
      this.references = new java.util.HashMap<String, String>();
    }
   ...
   /**
   * A collection of references and links to external resources that provide more details about the attack
   * @return references
  **/
  @ApiModelProperty(value = "A collection of references and links to external resources that provide more details about the attack")
  public java.util.Map<String, String> getReferences() {
    return references;
  }

  public void setReferences(java.util.Map<String, String> references) {
    this.references = references;
  }
   ...
   * @return description
  **/
  @ApiModelProperty(value = "A detailed description of the attack")
  public String getDescription() {
    return description;
  }

   /**
   * A description of steps which may be taken in order to remediate Vulnerabilities discovered by the attack
   * @return recommendation
  **/
  @ApiModelProperty(value = "A description of steps which may be taken in order to remediate Vulnerabilities discovered by the attack")
  ...
  public boolean equals(Object o) {
    ...
    AttackDocumentation attackDocumentation = (AttackDocumentation) o;
    return Objects.equals(this.references, attackDocumentation.references) &&
        Objects.equals(this.description, attackDocumentation.description) &&
        Objects.equals(this.recommendation, attackDocumentation.recommendation);
  }

  @Override
  public int hashCode() {
    return Objects.hash(references, description, recommendation);
  }
  ...
  public String toString() {
    ...
    sb.append("class AttackDocumentation {\n");
