  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, scan.id) &&
        Objects.equals(this.app, scan.app) &&
        Objects.equals(this.scanConfig, scan.scanConfig) &&
        Objects.equals(this.submitter, scan.submitter) &&
        Objects.equals(this.submitTime, scan.submitTime) &&
        Objects.equals(this.completionTime, scan.completionTime) &&
        Objects.equals(this.status, scan.status) &&
        Objects.equals(this.failureReason, scan.failureReason);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, app, scanConfig, submitter, submitTime, completionTime, status, failureReason);
  }
