...
public class AutoSequenceConfig {
  @SerializedName("sequence_ignore_content_type_list")
  private java.util.List<SequenceIgnoreContentType> sequenceIgnoreContentTypeList = null;

  @SerializedName("sequence_ignore_extension_list")
  private java.util.List<SequenceIgnoreExtension> sequenceIgnoreExtensionList = null;

  public AutoSequenceConfig sequenceIgnoreContentTypeList(java.util.List<SequenceIgnoreContentType> sequenceIgnoreContentTypeList) {
    this.sequenceIgnoreContentTypeList = sequenceIgnoreContentTypeList;
    return this;
  }

  public AutoSequenceConfig addSequenceIgnoreContentTypeListItem(SequenceIgnoreContentType sequenceIgnoreContentTypeListItem) {
    if (this.sequenceIgnoreContentTypeList == null) {
      this.sequenceIgnoreContentTypeList = new java.util.ArrayList<SequenceIgnoreContentType>();
    }
    this.sequenceIgnoreContentTypeList.add(sequenceIgnoreContentTypeListItem);
    return this;
  }

   /**
   * Get sequenceIgnoreContentTypeList
   * @return sequenceIgnoreContentTypeList
  **/
  @ApiModelProperty(value = "")
  public java.util.List<SequenceIgnoreContentType> getSequenceIgnoreContentTypeList() {
    return sequenceIgnoreContentTypeList;
  }

  public void setSequenceIgnoreContentTypeList(java.util.List<SequenceIgnoreContentType> sequenceIgnoreContentTypeList) {
    this.sequenceIgnoreContentTypeList = sequenceIgnoreContentTypeList;
  }

  public AutoSequenceConfig sequenceIgnoreExtensionList(java.util.List<SequenceIgnoreExtension> sequenceIgnoreExtensionList) {
    this.sequenceIgnoreExtensionList = sequenceIgnoreExtensionList;
    return this;
  }

  public AutoSequenceConfig addSequenceIgnoreExtensionListItem(SequenceIgnoreExtension sequenceIgnoreExtensionListItem) {
    if (this.sequenceIgnoreExtensionList == null) {
      this.sequenceIgnoreExtensionList = new java.util.ArrayList<SequenceIgnoreExtension>();
    }
    this.sequenceIgnoreExtensionList.add(sequenceIgnoreExtensionListItem);
    return this;
  }

   /**
   * Get sequenceIgnoreExtensionList
   * @return sequenceIgnoreExtensionList
  **/
  @ApiModelProperty(value = "")
  public java.util.List<SequenceIgnoreExtension> getSequenceIgnoreExtensionList() {
    return sequenceIgnoreExtensionList;
  }

  public void setSequenceIgnoreExtensionList(java.util.List<SequenceIgnoreExtension> sequenceIgnoreExtensionList) {
    this.sequenceIgnoreExtensionList = sequenceIgnoreExtensionList;
  }
  ...
  public boolean equals(Object o) {
    ...
    AutoSequenceConfig autoSequenceConfig = (AutoSequenceConfig) o;
    return Objects.equals(this.sequenceIgnoreContentTypeList, autoSequenceConfig.sequenceIgnoreContentTypeList) &&
        Objects.equals(this.sequenceIgnoreExtensionList, autoSequenceConfig.sequenceIgnoreExtensionList);
  }

  @Override
  public int hashCode() {
    return Objects.hash(sequenceIgnoreContentTypeList, sequenceIgnoreExtensionList);
  }
  ...
  public String toString() {
    ...
    sb.append("class AutoSequenceConfig {\n");

    sb.append("    sequenceIgnoreContentTypeList: ").append(toIndentedString(sequenceIgnoreContentTypeList)).append("\n");
    sb.append("    sequenceIgnoreExtensionList: ").append(toIndentedString(sequenceIgnoreExtensionList)).append("\n");
    sb.append("}");
    return sb.toString();
  }
