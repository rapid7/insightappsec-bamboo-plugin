...
public class BrowserFormLoginConfig {
  @SerializedName("final_delay_event_duration")
  private Long finalDelayEventDuration = null;

  @SerializedName("initial_navigate_event_duration")
  private Long initialNavigateEventDuration = null;

  public BrowserFormLoginConfig finalDelayEventDuration(Long finalDelayEventDuration) {
    this.finalDelayEventDuration = finalDelayEventDuration;
    return this;
  }

   /**
   * Get finalDelayEventDuration
   * @return finalDelayEventDuration
  **/
  @ApiModelProperty(value = "")
  public Long getFinalDelayEventDuration() {
    return finalDelayEventDuration;
  }

  public void setFinalDelayEventDuration(Long finalDelayEventDuration) {
    this.finalDelayEventDuration = finalDelayEventDuration;
  }

  public BrowserFormLoginConfig initialNavigateEventDuration(Long initialNavigateEventDuration) {
    this.initialNavigateEventDuration = initialNavigateEventDuration;
    return this;
  }

   /**
   * Get initialNavigateEventDuration
   * @return initialNavigateEventDuration
  **/
  @ApiModelProperty(value = "")
  public Long getInitialNavigateEventDuration() {
    return initialNavigateEventDuration;
  }

  public void setInitialNavigateEventDuration(Long initialNavigateEventDuration) {
    this.initialNavigateEventDuration = initialNavigateEventDuration;
  }
  ...
  public boolean equals(Object o) {
    ...
    BrowserFormLoginConfig browserFormLoginConfig = (BrowserFormLoginConfig) o;
    return Objects.equals(this.finalDelayEventDuration, browserFormLoginConfig.finalDelayEventDuration) &&
        Objects.equals(this.initialNavigateEventDuration, browserFormLoginConfig.initialNavigateEventDuration);
  }

  @Override
  public int hashCode() {
    return Objects.hash(finalDelayEventDuration, initialNavigateEventDuration);
  }
  ...
  public String toString() {
    ...
    sb.append("class BrowserFormLoginConfig {\n");

    sb.append("    finalDelayEventDuration: ").append(toIndentedString(finalDelayEventDuration)).append("\n");
    sb.append("    initialNavigateEventDuration: ").append(toIndentedString(initialNavigateEventDuration)).append("\n");
    sb.append("}");
    return sb.toString();
  }
