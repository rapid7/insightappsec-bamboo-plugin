...
public class DomRestrictions {
  @SerializedName("dom_element_restriction_list")
  private java.util.List<DomElementRestriction> domElementRestrictionList = null;
  ...
  public enum InitialStateEnum {
    ...
    public static InitialStateEnum fromValue(String text) {
    ...
    public static class Adapter extends TypeAdapter<InitialStateEnum> {
      ...
      public InitialStateEnum read(final JsonReader jsonReader) throws IOException {
        ...
        return InitialStateEnum.fromValue(String.valueOf(value));
      }
    }
  }
  ...
  public DomRestrictions domElementRestrictionList(java.util.List<DomElementRestriction> domElementRestrictionList) {
    this.domElementRestrictionList = domElementRestrictionList;
    return this;
  }

  public DomRestrictions addDomElementRestrictionListItem(DomElementRestriction domElementRestrictionListItem) {
    if (this.domElementRestrictionList == null) {
      this.domElementRestrictionList = new java.util.ArrayList<DomElementRestriction>();
    }
    this.domElementRestrictionList.add(domElementRestrictionListItem);
    return this;
  }

   /**
   * Get domElementRestrictionList
   * @return domElementRestrictionList
  **/
  @ApiModelProperty(value = "")
  public java.util.List<DomElementRestriction> getDomElementRestrictionList() {
    return domElementRestrictionList;
  }

  public void setDomElementRestrictionList(java.util.List<DomElementRestriction> domElementRestrictionList) {
    this.domElementRestrictionList = domElementRestrictionList;
  }

  public DomRestrictions enabled(Boolean enabled) {
  ...
  **/
  ...
  public DomRestrictions initialState(InitialStateEnum initialState) {
  ...
  **/
  ...
  public DomRestrictions name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public DomRestrictions scopeConstraintList(java.util.List<ScopeConstraint> scopeConstraintList) {
    this.scopeConstraintList = scopeConstraintList;
    return this;
  }

  public DomRestrictions addScopeConstraintListItem(ScopeConstraint scopeConstraintListItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DomRestrictions domRestrictions = (DomRestrictions) o;
    return Objects.equals(this.domElementRestrictionList, domRestrictions.domElementRestrictionList) &&
        Objects.equals(this.enabled, domRestrictions.enabled) &&
        Objects.equals(this.initialState, domRestrictions.initialState) &&
        Objects.equals(this.name, domRestrictions.name) &&
        Objects.equals(this.scopeConstraintList, domRestrictions.scopeConstraintList);
  }

  @Override
  public int hashCode() {
    return Objects.hash(domElementRestrictionList, enabled, initialState, name, scopeConstraintList);
  }
  ...
  public String toString() {
    ...
    sb.append("class DomRestrictions {\n");

    sb.append("    domElementRestrictionList: ").append(toIndentedString(domElementRestrictionList)).append("\n");
