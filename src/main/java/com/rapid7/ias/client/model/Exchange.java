...
public class Exchange {
  ...
  private String response = null;
   ...
   /**
   * The critical section of the request payload
   * @return request
  **/
  @ApiModelProperty(value = "The critical section of the request payload")
  public String getRequest() {
    return request;
  }

   /**
   * The critical section of the response payload
   * @return response
  **/
  @ApiModelProperty(value = "The critical section of the response payload")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.request, exchange.request) &&
