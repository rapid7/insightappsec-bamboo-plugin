...
public class ParameterParserConfig {
  @SerializedName("enable_base64_parameter_values")
  private Boolean enableBase64ParameterValues = null;

  @SerializedName("multi_regex_url_parser_config_list")
  private java.util.List<MultiRegexUrlParserConfig> multiRegexUrlParserConfigList = null;

  @SerializedName("standard_url_parser_config")
  private StandardUrlParserConfig standardUrlParserConfig = null;

  public ParameterParserConfig enableBase64ParameterValues(Boolean enableBase64ParameterValues) {
    this.enableBase64ParameterValues = enableBase64ParameterValues;
    return this;
  }

   /**
   * Get enableBase64ParameterValues
   * @return enableBase64ParameterValues
  **/
  @ApiModelProperty(value = "")
  public Boolean isEnableBase64ParameterValues() {
    return enableBase64ParameterValues;
  }

  public void setEnableBase64ParameterValues(Boolean enableBase64ParameterValues) {
    this.enableBase64ParameterValues = enableBase64ParameterValues;
  }

  public ParameterParserConfig multiRegexUrlParserConfigList(java.util.List<MultiRegexUrlParserConfig> multiRegexUrlParserConfigList) {
    this.multiRegexUrlParserConfigList = multiRegexUrlParserConfigList;
    return this;
  }

  public ParameterParserConfig addMultiRegexUrlParserConfigListItem(MultiRegexUrlParserConfig multiRegexUrlParserConfigListItem) {
    if (this.multiRegexUrlParserConfigList == null) {
      this.multiRegexUrlParserConfigList = new java.util.ArrayList<MultiRegexUrlParserConfig>();
    }
    this.multiRegexUrlParserConfigList.add(multiRegexUrlParserConfigListItem);
    return this;
  }

   /**
   * Get multiRegexUrlParserConfigList
   * @return multiRegexUrlParserConfigList
  **/
  @ApiModelProperty(value = "")
  public java.util.List<MultiRegexUrlParserConfig> getMultiRegexUrlParserConfigList() {
    return multiRegexUrlParserConfigList;
  }

  public void setMultiRegexUrlParserConfigList(java.util.List<MultiRegexUrlParserConfig> multiRegexUrlParserConfigList) {
    this.multiRegexUrlParserConfigList = multiRegexUrlParserConfigList;
  }

  public ParameterParserConfig standardUrlParserConfig(StandardUrlParserConfig standardUrlParserConfig) {
    this.standardUrlParserConfig = standardUrlParserConfig;
    return this;
  }

   /**
   * Get standardUrlParserConfig
   * @return standardUrlParserConfig
  **/
  @ApiModelProperty(value = "")
  public StandardUrlParserConfig getStandardUrlParserConfig() {
    return standardUrlParserConfig;
  }

  public void setStandardUrlParserConfig(StandardUrlParserConfig standardUrlParserConfig) {
    this.standardUrlParserConfig = standardUrlParserConfig;
  }
  ...
  public boolean equals(Object o) {
    ...
    ParameterParserConfig parameterParserConfig = (ParameterParserConfig) o;
    return Objects.equals(this.enableBase64ParameterValues, parameterParserConfig.enableBase64ParameterValues) &&
        Objects.equals(this.multiRegexUrlParserConfigList, parameterParserConfig.multiRegexUrlParserConfigList) &&
        Objects.equals(this.standardUrlParserConfig, parameterParserConfig.standardUrlParserConfig);
  }

  @Override
  public int hashCode() {
    return Objects.hash(enableBase64ParameterValues, multiRegexUrlParserConfigList, standardUrlParserConfig);
  }
  ...
  public String toString() {
    ...
    sb.append("class ParameterParserConfig {\n");

    sb.append("    enableBase64ParameterValues: ").append(toIndentedString(enableBase64ParameterValues)).append("\n");
    sb.append("    multiRegexUrlParserConfigList: ").append(toIndentedString(multiRegexUrlParserConfigList)).append("\n");
    sb.append("    standardUrlParserConfig: ").append(toIndentedString(standardUrlParserConfig)).append("\n");
    sb.append("}");
    return sb.toString();
  }
