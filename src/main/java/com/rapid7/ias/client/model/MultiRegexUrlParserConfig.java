...
public class MultiRegexUrlParserConfig {
  @SerializedName("parser_name")
  private String parserName = null;

  @SerializedName("path_parameter_groups")
  private String pathParameterGroups = null;

  @SerializedName("path_regex")
  private String pathRegex = null;

  @SerializedName("query_parameter_groups")
  private String queryParameterGroups = null;

  @SerializedName("query_regex")
  private String queryRegex = null;

  @SerializedName("rule_regex")
  private String ruleRegex = null;

  public MultiRegexUrlParserConfig parserName(String parserName) {
  ...
  **/
  ...
  public MultiRegexUrlParserConfig pathParameterGroups(String pathParameterGroups) {
    this.pathParameterGroups = pathParameterGroups;
    return this;
  }

   /**
   * Get pathParameterGroups
   * @return pathParameterGroups
  **/
  @ApiModelProperty(value = "")
  public String getPathParameterGroups() {
    return pathParameterGroups;
  }

  public void setPathParameterGroups(String pathParameterGroups) {
    this.pathParameterGroups = pathParameterGroups;
  }

  public MultiRegexUrlParserConfig pathRegex(String pathRegex) {
  ...
  **/
  ...
  public MultiRegexUrlParserConfig queryParameterGroups(String queryParameterGroups) {
    this.queryParameterGroups = queryParameterGroups;
    return this;
  }

   /**
   * Get queryParameterGroups
   * @return queryParameterGroups
  **/
  @ApiModelProperty(value = "")
  public String getQueryParameterGroups() {
    return queryParameterGroups;
  }

  public void setQueryParameterGroups(String queryParameterGroups) {
    this.queryParameterGroups = queryParameterGroups;
  }

  public MultiRegexUrlParserConfig queryRegex(String queryRegex) {
  ...
  **/
  ...
  public MultiRegexUrlParserConfig ruleRegex(String ruleRegex) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    MultiRegexUrlParserConfig multiRegexUrlParserConfig = (MultiRegexUrlParserConfig) o;
    return Objects.equals(this.parserName, multiRegexUrlParserConfig.parserName) &&
        Objects.equals(this.pathParameterGroups, multiRegexUrlParserConfig.pathParameterGroups) &&
        Objects.equals(this.pathRegex, multiRegexUrlParserConfig.pathRegex) &&
        Objects.equals(this.queryParameterGroups, multiRegexUrlParserConfig.queryParameterGroups) &&
        Objects.equals(this.queryRegex, multiRegexUrlParserConfig.queryRegex) &&
        Objects.equals(this.ruleRegex, multiRegexUrlParserConfig.ruleRegex);
  }

  @Override
  public int hashCode() {
    return Objects.hash(parserName, pathParameterGroups, pathRegex, queryParameterGroups, queryRegex, ruleRegex);
  }
  ...
  public String toString() {
    ...
    sb.append("class MultiRegexUrlParserConfig {\n");

    sb.append("    parserName: ").append(toIndentedString(parserName)).append("\n");
    sb.append("    pathParameterGroups: ").append(toIndentedString(pathParameterGroups)).append("\n");
    sb.append("    pathRegex: ").append(toIndentedString(pathRegex)).append("\n");
    sb.append("    queryParameterGroups: ").append(toIndentedString(queryParameterGroups)).append("\n");
    sb.append("    queryRegex: ").append(toIndentedString(queryRegex)).append("\n");
    sb.append("    ruleRegex: ").append(toIndentedString(ruleRegex)).append("\n");
    sb.append("}");
    return sb.toString();
  }
