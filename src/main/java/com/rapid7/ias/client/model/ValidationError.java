...
public class ValidationError {
   ...
   * @return type
  **/
  @ApiModelProperty(value = "The type of the validation error")
  public TypeEnum getType() {
    return type;
  }

   /**
   * An optional contextual indicator of a part of the request which failed validation
   * @return context
  **/
  @ApiModelProperty(value = "An optional contextual indicator of a part of the request which failed validation")
   ...
   * @return explanation
  **/
  @ApiModelProperty(value = "Details of the validation error")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, validationError.type) &&
        Objects.equals(this.context, validationError.context) &&
        Objects.equals(this.explanation, validationError.explanation);
  }

  @Override
  public int hashCode() {
    return Objects.hash(type, context, explanation);
  }
