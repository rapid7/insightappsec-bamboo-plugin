...
public class ScanSubmitter {
   ...
   * @return type
  **/
  @ApiModelProperty(value = "The type of submitter")
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ScanSubmitter scanSubmitter = (ScanSubmitter) o;
    return Objects.equals(this.type, scanSubmitter.type) &&
        Objects.equals(this.id, scanSubmitter.id);
  }
