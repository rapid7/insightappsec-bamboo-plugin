...
public class SearchRequest {
  ...
  public SearchRequest type(TypeEnum type) {
    this.type = type;
    return this;
  }
   ...
   * @return type
  **/
  @ApiModelProperty(required = true, value = "The type of resource to Search")
   ...
   * @return query
  **/
  @ApiModelProperty(required = true, value = "The query for the Search")
