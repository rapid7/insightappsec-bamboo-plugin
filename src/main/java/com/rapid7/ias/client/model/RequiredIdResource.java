...
public class RequiredIdResource {
  @SerializedName("id")
  private java.util.UUID id = null;

  public RequiredIdResource id(java.util.UUID id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    RequiredIdResource requiredIdResource = (RequiredIdResource) o;
    return Objects.equals(this.id, requiredIdResource.id);
  }
  ...
  public String toString() {
    ...
    sb.append("class RequiredIdResource {\n");
