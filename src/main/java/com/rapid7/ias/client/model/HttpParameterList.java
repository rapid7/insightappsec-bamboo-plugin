...
public class HttpParameterList {
  ...
  public HttpParameterList matchCriteria(MatchCriteriaEnum matchCriteria) {
  ...
  **/
  ...
  public HttpParameterList name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public HttpParameterList value(String value) {
    this.value = value;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    HttpParameterList httpParameterList = (HttpParameterList) o;
    return Objects.equals(this.matchCriteria, httpParameterList.matchCriteria) &&
        Objects.equals(this.name, httpParameterList.name) &&
        Objects.equals(this.value, httpParameterList.value);
  }

  @Override
  public int hashCode() {
    return Objects.hash(matchCriteria, name, value);
  }
  ...
  public String toString() {
    ...
    sb.append("class HttpParameterList {\n");
