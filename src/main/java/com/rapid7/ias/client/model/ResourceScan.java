...
public class ResourceScan {
  ...
  /**
   * The reason the Scan may have failed
   */
  ...
  **/
  ...
  public ResourceScan app(ReadOnlyIdResource app) {
    this.app = app;
    return this;
  }

   /**
   * The App to be associated with the Scan, must also be the App associated with the specified Scan Config
   * @return app
  **/
  ...
  public ResourceScan scanConfig(RequiredIdResource scanConfig) {
  ...
  **/
  ...
  public ResourceScan submitter(ScanSubmitter submitter) {
  ...
  **/
  ...
  public void setSubmitter(ScanSubmitter submitter) {
   ...
   /**
   * The time the Scan was submitted
   * @return submitTime
  **/
  ...
  public DateTime getSubmitTime() {
   ...
   /**
   * The time the Scan was completed
  ...
  **/
  ...
  public ResourceScan links(java.util.List<Link> links) {
    this.links = links;
    return this;
  }

  public ResourceScan addLinksItem(Link linksItem) {
    if (this.links == null) {
      this.links = new java.util.ArrayList<Link>();
    }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ResourceScan resourceScan = (ResourceScan) o;
    return Objects.equals(this.id, resourceScan.id) &&
        Objects.equals(this.app, resourceScan.app) &&
        Objects.equals(this.scanConfig, resourceScan.scanConfig) &&
        Objects.equals(this.submitter, resourceScan.submitter) &&
        Objects.equals(this.submitTime, resourceScan.submitTime) &&
        Objects.equals(this.completionTime, resourceScan.completionTime) &&
        Objects.equals(this.status, resourceScan.status) &&
        Objects.equals(this.failureReason, resourceScan.failureReason) &&
        Objects.equals(this.links, resourceScan.links);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, app, scanConfig, submitter, submitTime, completionTime, status, failureReason, links);
  }
  ...
  public String toString() {
    ...
    sb.append("class ResourceScan {\n");

    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    app: ").append(toIndentedString(app)).append("\n");
    sb.append("    scanConfig: ").append(toIndentedString(scanConfig)).append("\n");
