...
public class ParameterValueConfig {
  @SerializedName("parameter_value_list")
  private java.util.List<ParameterValue> parameterValueList = null;

  public ParameterValueConfig parameterValueList(java.util.List<ParameterValue> parameterValueList) {
    this.parameterValueList = parameterValueList;
    return this;
  }

  public ParameterValueConfig addParameterValueListItem(ParameterValue parameterValueListItem) {
    if (this.parameterValueList == null) {
      this.parameterValueList = new java.util.ArrayList<ParameterValue>();
    }
    this.parameterValueList.add(parameterValueListItem);
    return this;
  }

   /**
   * Get parameterValueList
  ...
  **/
  ...
  public void setParameterValueList(java.util.List<ParameterValue> parameterValueList) {
    this.parameterValueList = parameterValueList;
  }
  ...
  public boolean equals(Object o) {
    ...
    ParameterValueConfig parameterValueConfig = (ParameterValueConfig) o;
    return Objects.equals(this.parameterValueList, parameterValueConfig.parameterValueList);
  }

  @Override
  public int hashCode() {
    return Objects.hash(parameterValueList);
  }
  ...
  public String toString() {
    ...
    sb.append("class ParameterValueConfig {\n");

    sb.append("    parameterValueList: ").append(toIndentedString(parameterValueList)).append("\n");
    sb.append("}");
    return sb.toString();
  }
