...
public class MacroConfig {
  @SerializedName("macro_file_list")
  private java.util.List<MacroFile> macroFileList = null;

  @SerializedName("sequential_macro_playback")
  private Boolean sequentialMacroPlayback = null;

  public MacroConfig macroFileList(java.util.List<MacroFile> macroFileList) {
    this.macroFileList = macroFileList;
    return this;
  }

  public MacroConfig addMacroFileListItem(MacroFile macroFileListItem) {
    if (this.macroFileList == null) {
      this.macroFileList = new java.util.ArrayList<MacroFile>();
    }
    this.macroFileList.add(macroFileListItem);
    return this;
  }

   /**
   * Get macroFileList
   * @return macroFileList
  **/
  @ApiModelProperty(value = "")
  public java.util.List<MacroFile> getMacroFileList() {
    return macroFileList;
  }

  public void setMacroFileList(java.util.List<MacroFile> macroFileList) {
    this.macroFileList = macroFileList;
  }

  public MacroConfig sequentialMacroPlayback(Boolean sequentialMacroPlayback) {
    this.sequentialMacroPlayback = sequentialMacroPlayback;
    return this;
  }

   /**
   * Get sequentialMacroPlayback
   * @return sequentialMacroPlayback
  **/
  @ApiModelProperty(value = "")
  public Boolean isSequentialMacroPlayback() {
    return sequentialMacroPlayback;
  }

  public void setSequentialMacroPlayback(Boolean sequentialMacroPlayback) {
    this.sequentialMacroPlayback = sequentialMacroPlayback;
  }
  ...
  public boolean equals(Object o) {
    ...
    MacroConfig macroConfig = (MacroConfig) o;
    return Objects.equals(this.macroFileList, macroConfig.macroFileList) &&
        Objects.equals(this.sequentialMacroPlayback, macroConfig.sequentialMacroPlayback);
  }

  @Override
  public int hashCode() {
    return Objects.hash(macroFileList, sequentialMacroPlayback);
  }
  ...
  public String toString() {
    ...
    sb.append("class MacroConfig {\n");

    sb.append("    macroFileList: ").append(toIndentedString(macroFileList)).append("\n");
    sb.append("    sequentialMacroPlayback: ").append(toIndentedString(sequentialMacroPlayback)).append("\n");
    sb.append("}");
    return sb.toString();
  }
