...
public class ResourceScanConfig {
  ...
  @SerializedName("attack_template")
  ...
  **/
  ...
  public ResourceScanConfig description(String description) {
   ...
   /**
   * The description of the Scan Config
   * @return description
  **/
  ...
  public ResourceScanConfig app(RequiredIdResource app) {
   ...
   /**
   * The App that the Scan is associated with
   * @return app
  **/
  ...
  **/
  ...
  public ResourceScanConfig errors(java.util.List<String> errors) {
    this.errors = errors;
    return this;
  }
  ...
  public ResourceScanConfig addErrorsItem(String errorsItem) {
   ...
   /**
   * A list of errors that detail any current validation failures
   * @return errors
  **/
  ...
  public ResourceScanConfig links(java.util.List<Link> links) {
    this.links = links;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, resourceScanConfig.id) &&
        Objects.equals(this.name, resourceScanConfig.name) &&
        Objects.equals(this.description, resourceScanConfig.description) &&
        Objects.equals(this.app, resourceScanConfig.app) &&
        Objects.equals(this.attackTemplate, resourceScanConfig.attackTemplate) &&
        Objects.equals(this.errors, resourceScanConfig.errors) &&
        Objects.equals(this.links, resourceScanConfig.links);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, name, description, app, attackTemplate, errors, links);
  }
  ...
  public String toString() {
    ...
    sb.append("    attackTemplate: ").append(toIndentedString(attackTemplate)).append("\n");
