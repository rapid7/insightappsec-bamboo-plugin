...
public class PageScanConfig {
  @SerializedName("data")
  private java.util.List<ResourceScanConfig> data = null;
  ...
  public PageScanConfig data(java.util.List<ResourceScanConfig> data) {
    this.data = data;
    return this;
  }

  public PageScanConfig addDataItem(ResourceScanConfig dataItem) {
    if (this.data == null) {
      this.data = new java.util.ArrayList<ResourceScanConfig>();
    }
  ...
  **/
  ...
  public java.util.List<ResourceScanConfig> getData() {
    return data;
  }

  public void setData(java.util.List<ResourceScanConfig> data) {
    this.data = data;
  }

  public PageScanConfig metadata(PageMetadata metadata) {
  ...
  **/
  ...
  public PageScanConfig links(java.util.List<Link> links) {
    this.links = links;
    return this;
  }

  public PageScanConfig addLinksItem(Link linksItem) {
    if (this.links == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PageScanConfig pageScanConfig = (PageScanConfig) o;
    return Objects.equals(this.data, pageScanConfig.data) &&
        Objects.equals(this.metadata, pageScanConfig.metadata) &&
        Objects.equals(this.links, pageScanConfig.links);
  }
  ...
  public String toString() {
    ...
    sb.append("class PageScanConfig {\n");
