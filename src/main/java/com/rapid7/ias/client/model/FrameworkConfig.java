...
public class FrameworkConfig {
  @SerializedName("detection_regex")
  private String detectionRegex = null;
  ...
  @SerializedName("get_all_events_delay")
  private Long getAllEventsDelay = null;

  @SerializedName("get_all_events_script")
  private String getAllEventsScript = null;

  @SerializedName("healthcheck_string")
  private String healthcheckString = null;

  @SerializedName("name")
  private String name = null;

  public FrameworkConfig detectionRegex(String detectionRegex) {
  ...
  **/
  ...
  public FrameworkConfig enabled(Boolean enabled) {
  ...
  **/
  ...
  public FrameworkConfig fileName(String fileName) {
  ...
  **/
  ...
  public FrameworkConfig getAllEventsDelay(Long getAllEventsDelay) {
    this.getAllEventsDelay = getAllEventsDelay;
    return this;
  }

   /**
   * Get getAllEventsDelay
   * @return getAllEventsDelay
  **/
  @ApiModelProperty(value = "")
  public Long getGetAllEventsDelay() {
    return getAllEventsDelay;
  }

  public void setGetAllEventsDelay(Long getAllEventsDelay) {
    this.getAllEventsDelay = getAllEventsDelay;
  }

  public FrameworkConfig getAllEventsScript(String getAllEventsScript) {
    this.getAllEventsScript = getAllEventsScript;
    return this;
  }

   /**
   * Get getAllEventsScript
   * @return getAllEventsScript
  **/
  @ApiModelProperty(value = "")
  public String getGetAllEventsScript() {
    return getAllEventsScript;
  }

  public void setGetAllEventsScript(String getAllEventsScript) {
    this.getAllEventsScript = getAllEventsScript;
  }

  public FrameworkConfig healthcheckString(String healthcheckString) {
    this.healthcheckString = healthcheckString;
    return this;
  }

   /**
   * Get healthcheckString
  ...
  **/
  ...
  public FrameworkConfig name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    FrameworkConfig frameworkConfig = (FrameworkConfig) o;
    return Objects.equals(this.detectionRegex, frameworkConfig.detectionRegex) &&
        Objects.equals(this.enabled, frameworkConfig.enabled) &&
        Objects.equals(this.fileName, frameworkConfig.fileName) &&
        Objects.equals(this.getAllEventsDelay, frameworkConfig.getAllEventsDelay) &&
        Objects.equals(this.getAllEventsScript, frameworkConfig.getAllEventsScript) &&
        Objects.equals(this.healthcheckString, frameworkConfig.healthcheckString) &&
        Objects.equals(this.name, frameworkConfig.name);
  }

  @Override
  public int hashCode() {
    return Objects.hash(detectionRegex, enabled, fileName, getAllEventsDelay, getAllEventsScript, healthcheckString, name);
  }
  ...
  public String toString() {
    ...
    sb.append("class FrameworkConfig {\n");

    sb.append("    detectionRegex: ").append(toIndentedString(detectionRegex)).append("\n");
    sb.append("    enabled: ").append(toIndentedString(enabled)).append("\n");
    sb.append("    fileName: ").append(toIndentedString(fileName)).append("\n");
    sb.append("    getAllEventsDelay: ").append(toIndentedString(getAllEventsDelay)).append("\n");
    sb.append("    getAllEventsScript: ").append(toIndentedString(getAllEventsScript)).append("\n");
    sb.append("    healthcheckString: ").append(toIndentedString(healthcheckString)).append("\n");
