...
public class OneTimeTokenConfig {
  @SerializedName("auto_detect_csrf")
  private Boolean autoDetectCsrf = null;

  @SerializedName("expiration_regex")
  private String expirationRegex = null;

  @SerializedName("max_token_lifetime")
  private DateTime maxTokenLifetime = null;

  @SerializedName("token_name_regex")
  private String tokenNameRegex = null;

  @SerializedName("token_value_regex")
  private String tokenValueRegex = null;

  public OneTimeTokenConfig autoDetectCsrf(Boolean autoDetectCsrf) {
    this.autoDetectCsrf = autoDetectCsrf;
    return this;
  }

   /**
   * Get autoDetectCsrf
   * @return autoDetectCsrf
  **/
  @ApiModelProperty(value = "")
  public Boolean isAutoDetectCsrf() {
    return autoDetectCsrf;
  }

  public void setAutoDetectCsrf(Boolean autoDetectCsrf) {
    this.autoDetectCsrf = autoDetectCsrf;
  }

  public OneTimeTokenConfig expirationRegex(String expirationRegex) {
  ...
  **/
  ...
  public void setExpirationRegex(String expirationRegex) {
    this.expirationRegex = expirationRegex;
  }

  public OneTimeTokenConfig maxTokenLifetime(DateTime maxTokenLifetime) {
  ...
  **/
  @ApiModelProperty(value = "")
  public DateTime getMaxTokenLifetime() {
    return maxTokenLifetime;
  }

  public void setMaxTokenLifetime(DateTime maxTokenLifetime) {
    this.maxTokenLifetime = maxTokenLifetime;
  }

  public OneTimeTokenConfig tokenNameRegex(String tokenNameRegex) {
    this.tokenNameRegex = tokenNameRegex;
    return this;
  }

   /**
   * Get tokenNameRegex
   * @return tokenNameRegex
  **/
  @ApiModelProperty(value = "")
  ...
  public void setTokenNameRegex(String tokenNameRegex) {
    this.tokenNameRegex = tokenNameRegex;
  }

  public OneTimeTokenConfig tokenValueRegex(String tokenValueRegex) {
    this.tokenValueRegex = tokenValueRegex;
    return this;
  }

   /**
   * Get tokenValueRegex
   * @return tokenValueRegex
  **/
  @ApiModelProperty(value = "")
  ...
  public void setTokenValueRegex(String tokenValueRegex) {
    this.tokenValueRegex = tokenValueRegex;
  }
  ...
  public boolean equals(Object o) {
    ...
    OneTimeTokenConfig oneTimeTokenConfig = (OneTimeTokenConfig) o;
    return Objects.equals(this.autoDetectCsrf, oneTimeTokenConfig.autoDetectCsrf) &&
        Objects.equals(this.expirationRegex, oneTimeTokenConfig.expirationRegex) &&
        Objects.equals(this.maxTokenLifetime, oneTimeTokenConfig.maxTokenLifetime) &&
        Objects.equals(this.tokenNameRegex, oneTimeTokenConfig.tokenNameRegex) &&
        Objects.equals(this.tokenValueRegex, oneTimeTokenConfig.tokenValueRegex);
  }

  @Override
  public int hashCode() {
    return Objects.hash(autoDetectCsrf, expirationRegex, maxTokenLifetime, tokenNameRegex, tokenValueRegex);
  }
  ...
  public String toString() {
    ...
    sb.append("class OneTimeTokenConfig {\n");

    sb.append("    autoDetectCsrf: ").append(toIndentedString(autoDetectCsrf)).append("\n");
    sb.append("    expirationRegex: ").append(toIndentedString(expirationRegex)).append("\n");
    sb.append("    maxTokenLifetime: ").append(toIndentedString(maxTokenLifetime)).append("\n");
    sb.append("    tokenNameRegex: ").append(toIndentedString(tokenNameRegex)).append("\n");
    sb.append("    tokenValueRegex: ").append(toIndentedString(tokenValueRegex)).append("\n");
    sb.append("}");
    return sb.toString();
  }
