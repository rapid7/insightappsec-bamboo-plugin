...
public class MacroFile {
  ...
  @SerializedName("extra_delay_after_macro")
  private Long extraDelayAfterMacro = null;
  ...
  @SerializedName("macro_file_name")
  private String macroFileName = null;

  @SerializedName("replay_speed")
  private Double replaySpeed = null;

  @SerializedName("sequence_config")
  private SequenceConfig sequenceConfig = null;

  public MacroFile attackAsSequence(Boolean attackAsSequence) {
  ...
  **/
  ...
  public MacroFile extraDelayAfterMacro(Long extraDelayAfterMacro) {
    this.extraDelayAfterMacro = extraDelayAfterMacro;
    return this;
  }

   /**
   * Get extraDelayAfterMacro
   * @return extraDelayAfterMacro
  **/
  @ApiModelProperty(value = "")
  public Long getExtraDelayAfterMacro() {
    return extraDelayAfterMacro;
  }

  public void setExtraDelayAfterMacro(Long extraDelayAfterMacro) {
    this.extraDelayAfterMacro = extraDelayAfterMacro;
  }

  public MacroFile javaScriptEngine(JavaScriptEngineEnum javaScriptEngine) {
  ...
  **/
  ...
  public MacroFile macroFileName(String macroFileName) {
  ...
  **/
  ...
  public MacroFile replaySpeed(Double replaySpeed) {
  ...
  **/
  ...
  public MacroFile sequenceConfig(SequenceConfig sequenceConfig) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    MacroFile macroFile = (MacroFile) o;
    return Objects.equals(this.attackAsSequence, macroFile.attackAsSequence) &&
        Objects.equals(this.extraDelayAfterMacro, macroFile.extraDelayAfterMacro) &&
        Objects.equals(this.javaScriptEngine, macroFile.javaScriptEngine) &&
        Objects.equals(this.macroFileName, macroFile.macroFileName) &&
        Objects.equals(this.replaySpeed, macroFile.replaySpeed) &&
        Objects.equals(this.sequenceConfig, macroFile.sequenceConfig);
  }

  @Override
  public int hashCode() {
    return Objects.hash(attackAsSequence, extraDelayAfterMacro, javaScriptEngine, macroFileName, replaySpeed, sequenceConfig);
  }
  ...
  public String toString() {
    ...
    sb.append("class MacroFile {\n");

    sb.append("    attackAsSequence: ").append(toIndentedString(attackAsSequence)).append("\n");
    sb.append("    extraDelayAfterMacro: ").append(toIndentedString(extraDelayAfterMacro)).append("\n");
    ...
    sb.append("    replaySpeed: ").append(toIndentedString(replaySpeed)).append("\n");
    sb.append("    sequenceConfig: ").append(toIndentedString(sequenceConfig)).append("\n");
    sb.append("}");
    return sb.toString();
  }
