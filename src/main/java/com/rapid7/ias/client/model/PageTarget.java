...
public class PageTarget {
  @SerializedName("data")
  private java.util.List<ResourceTarget> data = null;
  ...
  public PageTarget data(java.util.List<ResourceTarget> data) {
    this.data = data;
    return this;
  }

  public PageTarget addDataItem(ResourceTarget dataItem) {
    if (this.data == null) {
      this.data = new java.util.ArrayList<ResourceTarget>();
    }
  ...
  **/
  ...
  public java.util.List<ResourceTarget> getData() {
    return data;
  }

  public void setData(java.util.List<ResourceTarget> data) {
    this.data = data;
  }

  public PageTarget metadata(PageMetadata metadata) {
  ...
  **/
  ...
  public PageTarget links(java.util.List<Link> links) {
    this.links = links;
    return this;
  }

  public PageTarget addLinksItem(Link linksItem) {
    if (this.links == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PageTarget pageTarget = (PageTarget) o;
    return Objects.equals(this.data, pageTarget.data) &&
        Objects.equals(this.metadata, pageTarget.metadata) &&
        Objects.equals(this.links, pageTarget.links);
  }
