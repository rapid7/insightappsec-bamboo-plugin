...
public class AttackMetadata {
  ...
  **/
   ...
   * @return type
  **/
  @ApiModelProperty(value = "The type of the attack")
  ...
  **/
  @ApiModelProperty(value = "The class of the attack")
   ...
   * @return description
  **/
  @ApiModelProperty(value = "The description of the attack")
  ...
  public boolean equals(Object o) {
    ...
    AttackMetadata attackMetadata = (AttackMetadata) o;
    return Objects.equals(this.id, attackMetadata.id) &&
        Objects.equals(this.type, attackMetadata.type) &&
        Objects.equals(this.propertyClass, attackMetadata.propertyClass) &&
        Objects.equals(this.description, attackMetadata.description);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, type, propertyClass, description);
  }
