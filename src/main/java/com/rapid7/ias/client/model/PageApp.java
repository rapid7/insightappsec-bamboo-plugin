...
public class PageApp {
  @SerializedName("data")
  private java.util.List<ResourceApp> data = null;
  ...
  public PageApp data(java.util.List<ResourceApp> data) {
    this.data = data;
    return this;
  }

  public PageApp addDataItem(ResourceApp dataItem) {
    if (this.data == null) {
      this.data = new java.util.ArrayList<ResourceApp>();
    }
  ...
  **/
  ...
  public java.util.List<ResourceApp> getData() {
    return data;
  }

  public void setData(java.util.List<ResourceApp> data) {
    this.data = data;
  }

  public PageApp metadata(PageMetadata metadata) {
  ...
  **/
  ...
  public PageApp links(java.util.List<Link> links) {
    this.links = links;
    return this;
  }

  public PageApp addLinksItem(Link linksItem) {
    if (this.links == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PageApp pageApp = (PageApp) o;
    return Objects.equals(this.data, pageApp.data) &&
        Objects.equals(this.metadata, pageApp.metadata) &&
        Objects.equals(this.links, pageApp.links);
  }
