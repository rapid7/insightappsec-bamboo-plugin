...
public class Variance {
  ...
  @SerializedName("original_exchange")
  ...
  @SerializedName("attack_value")
  private String attackValue = null;

  @SerializedName("attack_exchanges")
  private java.util.List<Exchange> attackExchanges = null;

  @SerializedName("message")
  private String message = null;

   /**
   * The value of a variable prior to being attacked
  ...
  **/
  ...
  public Variance originalExchange(Exchange originalExchange) {
   ...
   /**
   * The HTTP exchange executed prior to the attack
  ...
  **/
  ...
  public void setModule(ReadOnlyIdResource module) {
   ...
   /**
   * The value of a variable used to attack
   * @return attackValue
  **/
  ...
  public Variance attackExchanges(java.util.List<Exchange> attackExchanges) {
  ...
  public Variance addAttackExchangesItem(Exchange attackExchangesItem) {
    if (this.attackExchanges == null) {
      this.attackExchanges = new java.util.ArrayList<Exchange>();
    }
   ...
   * @return attackExchanges
  **/
  @ApiModelProperty(value = "The HTTP exchange executed as part of the attack")
  public java.util.List<Exchange> getAttackExchanges() {
    return attackExchanges;
  }

  public void setAttackExchanges(java.util.List<Exchange> attackExchanges) {
    this.attackExchanges = attackExchanges;
  }

   /**
   * A message that may highlight the result of the attack
   * @return message
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.originalValue, variance.originalValue) &&
        Objects.equals(this.originalExchange, variance.originalExchange) &&
        Objects.equals(this.attack, variance.attack) &&
        Objects.equals(this.module, variance.module) &&
        Objects.equals(this.attackValue, variance.attackValue) &&
        Objects.equals(this.attackExchanges, variance.attackExchanges) &&
        Objects.equals(this.message, variance.message);
  }

  @Override
  public int hashCode() {
    return Objects.hash(originalValue, originalExchange, attack, module, attackValue, attackExchanges, message);
  }
  ...
  public String toString() {
    ...
    sb.append("    originalExchange: ").append(toIndentedString(originalExchange)).append("\n");
    sb.append("    attack: ").append(toIndentedString(attack)).append("\n");
    sb.append("    module: ").append(toIndentedString(module)).append("\n");
    sb.append("    attackValue: ").append(toIndentedString(attackValue)).append("\n");
    sb.append("    attackExchanges: ").append(toIndentedString(attackExchanges)).append("\n");
