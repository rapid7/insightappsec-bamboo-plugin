...
public class ScanExecutionDetails {
  ...
  @SerializedName("links_in_queue")
  private Integer linksInQueue = null;

  @SerializedName("links_crawled")
  private Integer linksCrawled = null;

  @SerializedName("attacks_in_queue")
  private Integer attacksInQueue = null;

  @SerializedName("attacked")
  private Integer attacked = null;

  @SerializedName("vulnerable")
  private Integer vulnerable = null;

  @SerializedName("requests")
  private Integer requests = null;

  @SerializedName("failed_requests")
  private Integer failedRequests = null;

  @SerializedName("network_speed")
  private Integer networkSpeed = null;

  @SerializedName("drip_delay")
  private Integer dripDelay = null;

  public ScanExecutionDetails loggedIn(Boolean loggedIn) {
    this.loggedIn = loggedIn;
    return this;
  }

   /**
   * A flag which indicates if the Scan is using authentication during the Scan
   * @return loggedIn
  **/
  @ApiModelProperty(value = "A flag which indicates if the Scan is using authentication during the Scan")
  ...
  public ScanExecutionDetails linksInQueue(Integer linksInQueue) {
    this.linksInQueue = linksInQueue;
    return this;
  }

   /**
   * The number of links in the crawling queue
   * @return linksInQueue
  **/
  @ApiModelProperty(value = "The number of links in the crawling queue")
  public Integer getLinksInQueue() {
    return linksInQueue;
  }

  public void setLinksInQueue(Integer linksInQueue) {
    this.linksInQueue = linksInQueue;
  }

  public ScanExecutionDetails linksCrawled(Integer linksCrawled) {
    this.linksCrawled = linksCrawled;
    return this;
  }

   /**
   * The number of links already crawled
   * @return linksCrawled
  **/
  @ApiModelProperty(value = "The number of links already crawled")
  public Integer getLinksCrawled() {
    return linksCrawled;
  }

  public void setLinksCrawled(Integer linksCrawled) {
    this.linksCrawled = linksCrawled;
  }

  public ScanExecutionDetails attacksInQueue(Integer attacksInQueue) {
    this.attacksInQueue = attacksInQueue;
    return this;
  }

   /**
   * The number of links in the attacking queue
   * @return attacksInQueue
  **/
  @ApiModelProperty(value = "The number of links in the attacking queue")
  public Integer getAttacksInQueue() {
    return attacksInQueue;
  }

  public void setAttacksInQueue(Integer attacksInQueue) {
    this.attacksInQueue = attacksInQueue;
  }

  public ScanExecutionDetails attacked(Integer attacked) {
    this.attacked = attacked;
    return this;
  }

   /**
   * The number of attacks already performed
   * @return attacked
  **/
  @ApiModelProperty(value = "The number of attacks already performed")
  public Integer getAttacked() {
    return attacked;
  }

  public void setAttacked(Integer attacked) {
    this.attacked = attacked;
  }

  public ScanExecutionDetails vulnerable(Integer vulnerable) {
   ...
   * @return vulnerable
  **/
  @ApiModelProperty(value = "The number of potential findings")
  ...
  public ScanExecutionDetails requests(Integer requests) {
    this.requests = requests;
    return this;
  }

   /**
   * The number of HTTP requests which have been executed
   * @return requests
  **/
  @ApiModelProperty(value = "The number of HTTP requests which have been executed")
  ...
  public ScanExecutionDetails failedRequests(Integer failedRequests) {
  ...
  **/
  @ApiModelProperty(value = "The number of failed HTTP requests")
  ...
  public ScanExecutionDetails networkSpeed(Integer networkSpeed) {
   ...
   * @return networkSpeed
  **/
  @ApiModelProperty(value = "A throughput indicator")
  ...
  public ScanExecutionDetails dripDelay(Integer dripDelay) {
    this.dripDelay = dripDelay;
    return this;
  }

   /**
   * The current delay between HTTP requests
   * @return dripDelay
  **/
  @ApiModelProperty(value = "The current delay between HTTP requests")
  public Integer getDripDelay() {
    return dripDelay;
  }

  public void setDripDelay(Integer dripDelay) {
    this.dripDelay = dripDelay;
  }
  ...
  public boolean equals(Object o) {
    ...
    ScanExecutionDetails scanExecutionDetails = (ScanExecutionDetails) o;
    return Objects.equals(this.loggedIn, scanExecutionDetails.loggedIn) &&
        Objects.equals(this.linksInQueue, scanExecutionDetails.linksInQueue) &&
        Objects.equals(this.linksCrawled, scanExecutionDetails.linksCrawled) &&
        Objects.equals(this.attacksInQueue, scanExecutionDetails.attacksInQueue) &&
        Objects.equals(this.attacked, scanExecutionDetails.attacked) &&
        Objects.equals(this.vulnerable, scanExecutionDetails.vulnerable) &&
        Objects.equals(this.requests, scanExecutionDetails.requests) &&
        Objects.equals(this.failedRequests, scanExecutionDetails.failedRequests) &&
        Objects.equals(this.networkSpeed, scanExecutionDetails.networkSpeed) &&
        Objects.equals(this.dripDelay, scanExecutionDetails.dripDelay);
  }

  @Override
  public int hashCode() {
    return Objects.hash(loggedIn, linksInQueue, linksCrawled, attacksInQueue, attacked, vulnerable, requests, failedRequests, networkSpeed, dripDelay);
  }
  ...
  public String toString() {
    ...
    sb.append("class ScanExecutionDetails {\n");

    sb.append("    loggedIn: ").append(toIndentedString(loggedIn)).append("\n");
    sb.append("    linksInQueue: ").append(toIndentedString(linksInQueue)).append("\n");
    sb.append("    linksCrawled: ").append(toIndentedString(linksCrawled)).append("\n");
    sb.append("    attacksInQueue: ").append(toIndentedString(attacksInQueue)).append("\n");
    sb.append("    attacked: ").append(toIndentedString(attacked)).append("\n");
    ...
    sb.append("    networkSpeed: ").append(toIndentedString(networkSpeed)).append("\n");
    sb.append("    dripDelay: ").append(toIndentedString(dripDelay)).append("\n");
    sb.append("}");
    return sb.toString();
  }
