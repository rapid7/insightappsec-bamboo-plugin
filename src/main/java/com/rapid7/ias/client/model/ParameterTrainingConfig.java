...
public class ParameterTrainingConfig {
  /**
   * Gets or Sets formPopulation
   */
  @JsonAdapter(FormPopulationEnum.Adapter.class)
  public enum FormPopulationEnum {
    NONE("NONE"),
    ...
    FormPopulationEnum(String value) {
      this.value = value;
    }
    ...
    public static FormPopulationEnum fromValue(String text) {
      for (FormPopulationEnum b : FormPopulationEnum.values()) {
    ...
    public static class Adapter extends TypeAdapter<FormPopulationEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final FormPopulationEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public FormPopulationEnum read(final JsonReader jsonReader) throws IOException {
        String value = jsonReader.nextString();
        return FormPopulationEnum.fromValue(String.valueOf(value));
      }
    }
  }

  @SerializedName("form_population")
  private FormPopulationEnum formPopulation = null;

  @SerializedName("training_parameter_list")
  private java.util.List<TrainingParameter> trainingParameterList = null;

  public ParameterTrainingConfig formPopulation(FormPopulationEnum formPopulation) {
  ...
  **/
  ...
  public FormPopulationEnum getFormPopulation() {
    return formPopulation;
  }

  public void setFormPopulation(FormPopulationEnum formPopulation) {
    this.formPopulation = formPopulation;
  }

  public ParameterTrainingConfig trainingParameterList(java.util.List<TrainingParameter> trainingParameterList) {
    this.trainingParameterList = trainingParameterList;
    return this;
  }

  public ParameterTrainingConfig addTrainingParameterListItem(TrainingParameter trainingParameterListItem) {
    if (this.trainingParameterList == null) {
      this.trainingParameterList = new java.util.ArrayList<TrainingParameter>();
    }
    this.trainingParameterList.add(trainingParameterListItem);
    return this;
  }

   /**
   * Get trainingParameterList
   * @return trainingParameterList
  **/
  @ApiModelProperty(value = "")
  public java.util.List<TrainingParameter> getTrainingParameterList() {
    return trainingParameterList;
  }

  public void setTrainingParameterList(java.util.List<TrainingParameter> trainingParameterList) {
    this.trainingParameterList = trainingParameterList;
  }
  ...
  public boolean equals(Object o) {
    ...
    ParameterTrainingConfig parameterTrainingConfig = (ParameterTrainingConfig) o;
    return Objects.equals(this.formPopulation, parameterTrainingConfig.formPopulation) &&
        Objects.equals(this.trainingParameterList, parameterTrainingConfig.trainingParameterList);
  }

  @Override
  public int hashCode() {
    return Objects.hash(formPopulation, trainingParameterList);
  }
  ...
  public String toString() {
    ...
    sb.append("class ParameterTrainingConfig {\n");

    sb.append("    formPopulation: ").append(toIndentedString(formPopulation)).append("\n");
    sb.append("    trainingParameterList: ").append(toIndentedString(trainingParameterList)).append("\n");
    sb.append("}");
    return sb.toString();
  }
