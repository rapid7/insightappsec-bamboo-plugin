...
public class SequenceRequestList {
  /**
   * Gets or Sets sequenceRequestType
   */
  @JsonAdapter(SequenceRequestTypeEnum.Adapter.class)
  public enum SequenceRequestTypeEnum {
    ...
    SequenceRequestTypeEnum(String value) {
      this.value = value;
    }
    ...
    public static SequenceRequestTypeEnum fromValue(String text) {
      for (SequenceRequestTypeEnum b : SequenceRequestTypeEnum.values()) {
    ...
    public static class Adapter extends TypeAdapter<SequenceRequestTypeEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final SequenceRequestTypeEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public SequenceRequestTypeEnum read(final JsonReader jsonReader) throws IOException {
        String value = jsonReader.nextString();
        return SequenceRequestTypeEnum.fromValue(String.valueOf(value));
      }
    }
  }

  @SerializedName("sequence_request_type")
  private SequenceRequestTypeEnum sequenceRequestType = null;

  @SerializedName("url")
  private String url = null;

  public SequenceRequestList sequenceRequestType(SequenceRequestTypeEnum sequenceRequestType) {
    this.sequenceRequestType = sequenceRequestType;
    return this;
  }

   /**
   * Get sequenceRequestType
   * @return sequenceRequestType
  **/
  @ApiModelProperty(value = "")
  public SequenceRequestTypeEnum getSequenceRequestType() {
    return sequenceRequestType;
  }

  public void setSequenceRequestType(SequenceRequestTypeEnum sequenceRequestType) {
    this.sequenceRequestType = sequenceRequestType;
  }

  public SequenceRequestList url(String url) {
    this.url = url;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    SequenceRequestList sequenceRequestList = (SequenceRequestList) o;
    return Objects.equals(this.sequenceRequestType, sequenceRequestList.sequenceRequestType) &&
        Objects.equals(this.url, sequenceRequestList.url);
  }

  @Override
  public int hashCode() {
    return Objects.hash(sequenceRequestType, url);
  }
  ...
  public String toString() {
    ...
    sb.append("class SequenceRequestList {\n");

    sb.append("    sequenceRequestType: ").append(toIndentedString(sequenceRequestType)).append("\n");
