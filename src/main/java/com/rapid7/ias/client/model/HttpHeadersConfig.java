...
public class HttpHeadersConfig {
  ...
  @SerializedName("custom_headers_list")
  private java.util.List<CustomHeaders> customHeadersList = null;

  @SerializedName("http_protocol")
  private String httpProtocol = null;

  @SerializedName("overwrite_with_default_headers")
  private Boolean overwriteWithDefaultHeaders = null;

  @SerializedName("traffic_header_list")
  private java.util.List<TrafficHeader> trafficHeaderList = null;

  @SerializedName("user_agent")
  private String userAgent = null;

  public HttpHeadersConfig accept(String accept) {
    this.accept = accept;
    return this;
  }
  ...
  **/
  ...
  public HttpHeadersConfig acceptCharset(String acceptCharset) {
  ...
  **/
  ...
  public HttpHeadersConfig acceptEncoding(String acceptEncoding) {
  ...
  **/
  ...
  public HttpHeadersConfig acceptLanguage(String acceptLanguage) {
  ...
  **/
  ...
  public HttpHeadersConfig cookie(String cookie) {
    this.cookie = cookie;
    return this;
  }
  ...
  **/
  ...
  public HttpHeadersConfig customHeadersList(java.util.List<CustomHeaders> customHeadersList) {
    this.customHeadersList = customHeadersList;
    return this;
  }

  public HttpHeadersConfig addCustomHeadersListItem(CustomHeaders customHeadersListItem) {
    if (this.customHeadersList == null) {
      this.customHeadersList = new java.util.ArrayList<CustomHeaders>();
    }
    this.customHeadersList.add(customHeadersListItem);
    return this;
  }

   /**
   * Get customHeadersList
   * @return customHeadersList
  **/
  @ApiModelProperty(value = "")
  public java.util.List<CustomHeaders> getCustomHeadersList() {
    return customHeadersList;
  }

  public void setCustomHeadersList(java.util.List<CustomHeaders> customHeadersList) {
    this.customHeadersList = customHeadersList;
  }

  public HttpHeadersConfig httpProtocol(String httpProtocol) {
  ...
  **/
  ...
  public HttpHeadersConfig overwriteWithDefaultHeaders(Boolean overwriteWithDefaultHeaders) {
    this.overwriteWithDefaultHeaders = overwriteWithDefaultHeaders;
    return this;
  }

   /**
   * Get overwriteWithDefaultHeaders
   * @return overwriteWithDefaultHeaders
  **/
  @ApiModelProperty(value = "")
  public Boolean isOverwriteWithDefaultHeaders() {
    return overwriteWithDefaultHeaders;
  }

  public void setOverwriteWithDefaultHeaders(Boolean overwriteWithDefaultHeaders) {
    this.overwriteWithDefaultHeaders = overwriteWithDefaultHeaders;
  }

  public HttpHeadersConfig trafficHeaderList(java.util.List<TrafficHeader> trafficHeaderList) {
    this.trafficHeaderList = trafficHeaderList;
    return this;
  }

  public HttpHeadersConfig addTrafficHeaderListItem(TrafficHeader trafficHeaderListItem) {
    if (this.trafficHeaderList == null) {
      this.trafficHeaderList = new java.util.ArrayList<TrafficHeader>();
    }
    this.trafficHeaderList.add(trafficHeaderListItem);
    return this;
  }

   /**
   * Get trafficHeaderList
   * @return trafficHeaderList
  **/
  @ApiModelProperty(value = "")
  public java.util.List<TrafficHeader> getTrafficHeaderList() {
    return trafficHeaderList;
  }

  public void setTrafficHeaderList(java.util.List<TrafficHeader> trafficHeaderList) {
    this.trafficHeaderList = trafficHeaderList;
  }

  public HttpHeadersConfig userAgent(String userAgent) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    HttpHeadersConfig httpHeadersConfig = (HttpHeadersConfig) o;
    return Objects.equals(this.accept, httpHeadersConfig.accept) &&
        Objects.equals(this.acceptCharset, httpHeadersConfig.acceptCharset) &&
        Objects.equals(this.acceptEncoding, httpHeadersConfig.acceptEncoding) &&
        Objects.equals(this.acceptLanguage, httpHeadersConfig.acceptLanguage) &&
        Objects.equals(this.cookie, httpHeadersConfig.cookie) &&
        Objects.equals(this.customHeadersList, httpHeadersConfig.customHeadersList) &&
        Objects.equals(this.httpProtocol, httpHeadersConfig.httpProtocol) &&
        Objects.equals(this.overwriteWithDefaultHeaders, httpHeadersConfig.overwriteWithDefaultHeaders) &&
        Objects.equals(this.trafficHeaderList, httpHeadersConfig.trafficHeaderList) &&
        Objects.equals(this.userAgent, httpHeadersConfig.userAgent);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accept, acceptCharset, acceptEncoding, acceptLanguage, cookie, customHeadersList, httpProtocol, overwriteWithDefaultHeaders, trafficHeaderList, userAgent);
  }
  ...
  public String toString() {
    ...
    sb.append("class HttpHeadersConfig {\n");
    ...
    sb.append("    customHeadersList: ").append(toIndentedString(customHeadersList)).append("\n");
    sb.append("    httpProtocol: ").append(toIndentedString(httpProtocol)).append("\n");
    sb.append("    overwriteWithDefaultHeaders: ").append(toIndentedString(overwriteWithDefaultHeaders)).append("\n");
    sb.append("    trafficHeaderList: ").append(toIndentedString(trafficHeaderList)).append("\n");
